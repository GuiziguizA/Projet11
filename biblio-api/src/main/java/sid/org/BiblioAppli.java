...
public class BiblioAppli implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Livre livre1 = livreService.createLivre(
				new LivreDto("les trois mousquetaires", "Alexandre DUMAS", "type1", "section1", "emplacement1", 3));
		...
		Pret pret6 = pretRepository.save(new Pret(new Date(), new Date(), "remis", 1, livre1, user1));
